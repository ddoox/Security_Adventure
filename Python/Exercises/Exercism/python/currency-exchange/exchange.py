...
Overview of exchanging currency when travelling: https://www.compareremit.com/money-transfer-tips/guide-to-exchanging-
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    value_after_exchange = budget / real_exchange_rate
